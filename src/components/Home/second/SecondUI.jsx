...
const SecondUI = () => {
  ...
  return (
    <div className={styles.Container} ref={ref}>
      <h1 className={isInViewport && styles.Title}>
        나만 알고 싶은 작품을 소개하기.
      </h1>
      <h3 className={isInViewport && styles.SubTitle}>
        내가 좋아하는 영화/드라마를 다른 사람과 공유해보세요
      </h3>
      <div className={isInViewport && styles.Poster}>
        <MoviePoster movie={dummyMovies[4]} />

        <div className={isInViewport && styles.BubblePosition1}>
        ...
        <div className={isInViewport && styles.BubblePosition2}>
      ...
      <div className={isInViewport && `${styles.Circle} ${styles.Circle1}`} />
